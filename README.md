...
### 2019年度 ゼミ論文
青山学院大学 地球社会共生学部 地球社会共生学科（1A117010）飯塚みのり   
指導教員：青山学院大学 地球社会共生学部 地球社会共生学科 教授 古橋大地
　  
 ***
...
　この研究では「グループで討論すること」「自ら体験すること」「他人に教えること」等のアクティブラーニングを行う場合では、さらに記憶定着率が高く、順に50%、75%、90%であると提唱されている。本研究におけるマニュアル動画は、これらアクティブラーニングの母体とはなりかねるが、動画を視聴することで、アクティブラーニング、特に「自ら体験すること」を促す一助となるだろう。
...
　2点目については前項にて述べた動画の優位性に基づいて検討した。今回製作した動画では、特に「視覚と聴覚に訴えかけ多くの情報を伝達できる」点と「記憶定着率が高い」点において文字や画像よりもマップツールのマニュアルを作成する形式として適していると考えた。   
...
　同時に、マニュアルを動画で作成することの意義について提唱した。   
　動画は文字や画像より視覚と聴覚に訴えかけより多くの情報を素早く、正確に、わかりやすく伝達できる点や、記憶定着率が高い点で優れており、マニュアルを作成する際には、動画という形式が適していると考えられる。さらなる記憶定着率を実現する、「自らが体験する」ことを促す一助となり得る。   
　今回は、閲覧者をマップツールの使用は初心者である人物と想定し、その閲覧者に向けて動画を作成したが、今後に引き継ぐべき課題としては、想定される閲覧者のStrava利用フェーズに適応して映像内容を検討していき、その閲覧者に向けたバージョンを作る必要がある。また、本研究においてマニュアルを動画で作成することの意義について提唱することができたので、さらに複雑な他のマップツールの場合だとどのような応用性があるのかを検討することもできるだろう。      
...
- [野村ナイル（2019）「効率的な映像教育教材コンテンツ作成手法の開発」](https://furuhashilab.github.io/www4nairu/)   
...
リスト：https://docs.google.com/spreadsheets/d/1HSv24ByNLr5uB60btJkZcKtf2cuaRxcpQCaULPn3EW4/edit?usp=sharing
<br />
<br />
<br />
